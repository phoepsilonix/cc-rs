...
## [0.1.7](https://github.com/phoepsilonix/cc-rs/compare/find-msvc-tools-v0.1.6...find-msvc-tools-v0.1.7) - 2026-01-09

### Other

- Fix tool existence check in find_tool method ([#1645](https://github.com/phoepsilonix/cc-rs/pull/1645))
- Fix SdkInfo::find_tool to check for executable extension ([#1644](https://github.com/phoepsilonix/cc-rs/pull/1644))
