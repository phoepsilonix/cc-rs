...
## [1.4.5](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.4.4...cc-v1.4.5) - 2026-09-04

### Fixed

- probe flag support without OUT_DIR via tempfile ([#1875](https://github.com/phoepsilonix/cc-rs/pull/1875))

### Other

- simplify conditional logic using `then` method ([#1860](https://github.com/phoepsilonix/cc-rs/pull/1860))
