...
## [1.2.22](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.21...cc-v1.2.22) - 2025-05-09

### Other

- Add `flags` method to `cc::Build` for adding multiple flags ([#1466](https://github.com/phoepsilonix/cc-rs/pull/1466))
