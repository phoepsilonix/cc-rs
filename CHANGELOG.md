...
## [1.4.4](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.4.3...cc-v1.4.4) - 2026-08-21

### Fixed

- run the Android llvm-ar probe in the caller's environment ([#1868](https://github.com/phoepsilonix/cc-rs/pull/1868))
- honor Build::env overrides in flag support probes ([#1866](https://github.com/phoepsilonix/cc-rs/pull/1866))
