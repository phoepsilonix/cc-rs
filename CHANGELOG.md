...
## [1.2.40](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.39...cc-v1.2.40) - 2025-10-03

### Other

- Reorder changelog and remove duplicate Unreleased section ([#1579](https://github.com/phoepsilonix/cc-rs/pull/1579))
- Prefer clang if linker-plugin-lto specified ([#1573](https://github.com/phoepsilonix/cc-rs/pull/1573))
- Fix building for Mac Catalyst ([#1577](https://github.com/phoepsilonix/cc-rs/pull/1577))
- Improve ESP microcontroller targets ([#1574](https://github.com/phoepsilonix/cc-rs/pull/1574))
