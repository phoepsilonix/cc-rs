...
## [1.2.62](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.61...cc-v1.2.62) - 2026-05-08

### Other

- Regenerate target info ([#1721](https://github.com/phoepsilonix/cc-rs/pull/1721))
- Allow exceptions on wasm platforms ([#1714](https://github.com/phoepsilonix/cc-rs/pull/1714))
- Add relibc env ([#1710](https://github.com/phoepsilonix/cc-rs/pull/1710))
- recognize sh4 architecture in parse_arch() ([#1712](https://github.com/phoepsilonix/cc-rs/pull/1712))
