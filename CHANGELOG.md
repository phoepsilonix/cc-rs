...
## [1.2.33](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.32...cc-v1.2.33) - 2025-08-15

### Other

- Regenerate target info ([#1521](https://github.com/phoepsilonix/cc-rs/pull/1521))
- Bump actions/checkout from 4 to 5 ([#1520](https://github.com/phoepsilonix/cc-rs/pull/1520))
- [win][arm64ec] Add testing for Arm64EC Windows ([#1512](https://github.com/phoepsilonix/cc-rs/pull/1512))
- Fix gen-windows-sys-binding ([#1518](https://github.com/phoepsilonix/cc-rs/pull/1518))
- Fix parsing of nigthly targets ([#1517](https://github.com/phoepsilonix/cc-rs/pull/1517))
- [win][arm64ec] Fix finding assembler and setting is_arm for Arm64EC ([#1511](https://github.com/phoepsilonix/cc-rs/pull/1511))
