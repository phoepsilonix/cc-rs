...
## [1.2.52](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.51...cc-v1.2.52) - 2026-01-09

### Other

- Fix contradictory doc for CC compiler in crate doc ([#1650](https://github.com/phoepsilonix/cc-rs/pull/1650))
- Have CUDA compilaion check for sbsa-linux when targeting aarch64. ([#1647](https://github.com/phoepsilonix/cc-rs/pull/1647))
- Update link for -Cdwarf-version; Remove -Z (stabilized in 1.88) ([#1648](https://github.com/phoepsilonix/cc-rs/pull/1648))
- Fix Build::env_tool to check for .exe on windows ([#1646](https://github.com/phoepsilonix/cc-rs/pull/1646))
