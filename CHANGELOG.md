...
## [1.2.31](https://github.com/phoepsilonix/cc-rs/compare/cc-v1.2.30...cc-v1.2.31) - 2025-08-01

### Other

- ability to statically link against C++ stdlib ([#1497](https://github.com/phoepsilonix/cc-rs/pull/1497))
- Add instructions on using sccache ([#1503](https://github.com/phoepsilonix/cc-rs/pull/1503))
- Add support for recognizing some architectures supported by GCC, but not LLVM. ([#1500](https://github.com/phoepsilonix/cc-rs/pull/1500))
# Changelog
All notable changes to this project will be documented in this file.
